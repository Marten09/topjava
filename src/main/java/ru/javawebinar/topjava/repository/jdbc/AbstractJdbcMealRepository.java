...
public abstract class AbstractJdbcMealRepository implements MealRepository {
    ...
    public Meal save(Meal meal, int userId) {
        MapSqlParameterSource map = new MapSqlParameterSource()
                ...
                .addValue("date_time", toDbLocalDateTime(meal.getDateTime()))
    ...
    public List<Meal> getBetweenHalfOpen(LocalDateTime startDateTime, LocalDateTime endDateTime, int userId) {
        return jdbcTemplate.query(
                ...
                ROW_MAPPER, userId, toDbLocalDateTime(startDateTime), toDbLocalDateTime(endDateTime));
    }

    abstract Object toDbLocalDateTime(LocalDateTime ldt);
}
